      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-md">
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-400 hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
              Sign Up
            </button>
          </div>
