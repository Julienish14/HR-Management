      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-md">
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
              Login
            </button>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>Release Notes</p>
          <p>version: 20.2.23</p>
          <p className="mt-2">Copyright © 2023-24 Next and Services</p>
        </div>
      </div>
    </div>
  );
